...
async def infobot(message: types.Message):
    await message.answer('Этот бот может найти любую информацию через команду "/find".\n'
                         ...
                         '------------------------------------------\n'
                         'Написать любую история(хоррор и т.д) через команду "/hs.\n'
                         'Команду нужно писать так >>>\n'
                         ' /hs история со школы. Полностью на '
                         'русском. Состоящем из 4 предложений"\n'
                         '------------------------------------------\n')
# -----------------------------------------------------------------------------------
...
def handler_client(dp: Dispatcher):
    ...
    dp.register_message_handler(infobot, commands=['infobot'])